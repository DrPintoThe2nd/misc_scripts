...
seqkit sort -l -r $1 2>/dev/null | awk '/^>/{print ">altchr_" ++i; next}{print}' > zzzzzzzzzztmp1 
...
seqkit sort -l -r zzzzzzzzzztmp2 2>/dev/null | awk '/^>/{print ">altctg_" ++i; next}{print}' > zzzzzzzzzzscaf  
echo "########## (50%)"
